            ...
            <Col flex="auto">
              <Space direction="vertical" size={4}>
                ...
                <Text style={{ color: '#f0f0f0', fontSize: 13 }}>
                  {dashboardType === 'developer' && selectedStaff && `Showing comprehensive productivity metrics and insights for ${selectedStaff.staff_name || selectedStaff.name || 'selected developer'}`}
